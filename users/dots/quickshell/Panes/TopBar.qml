      ...
      Rectangle {
        ...
        Text {
          ...
          MouseArea {
            ...
            onClicked: mouse => {
              switch (mouse.button) {
                case Qt.MiddleButton: Data.Audio.sink.audio.muted = !Data.Audio.muted; break;
                case Qt.RightButton: Data.Audio.source.audio.muted = !Data.Audio.source.audio.muted; break;
              }
            }
